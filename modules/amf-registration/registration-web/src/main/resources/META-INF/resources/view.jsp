...
<c:choose>
	<c:when test="<%= themeDisplay.isSignedIn() %>" >
		<clay:alert title="Info" message="User is already signed in." />
	</c:when>
	<c:otherwise>
		<aui:form action="${registrationActionURL}">
			<aui:fieldset-group markupView="lexicon">
				<aui:fieldset style="padding: 10px" label="Personal Information">
					<aui:row>
						<aui:col width="50">
							<aui:input label="Username" name="username" type="text" required="true"/>
						</aui:col>
						<aui:col width="50">
							<aui:input label="Email" name="email" type="text" required="true"/>
						</aui:col>
					</aui:row>
					<aui:row>
						<aui:col width="50">
							<aui:input label="First Name" name="first_name" type="text" required="true"/>
						</aui:col>
						<aui:col width="50">
							<aui:input label="Last Name" name="last_name" type="text" required="true"/>
						</aui:col>
					</aui:row>
					<aui:row>
						<aui:col width="20">
						...
						<aui:col width="15">
							...
							<liferay-ui:input-date required="true" dayValue="1" monthValue="1" yearValue="1985" dayParam="bDay" monthParam="bMonth" yearParam="bYear"/>
						</aui:col>
					</aui:row>
					<aui:row>
						<aui:col width="50">
							<aui:input label="Password" name="password1" type="password" required="true"/>
						</aui:col>
						<aui:col width="50">
							<aui:input label="Confirm Password" name="password2" type="password" required="true"/>
						</aui:col>
					</aui:row>
				</aui:fieldset>
				...
				<aui:fieldset style="padding: 10px" label="Billing Information">
					<aui:row>
						<aui:col width="50">
							<aui:input label="Address 1" name="address" type="input" required="true"/>
						</aui:col>
						<aui:col width="25">
							<aui:input label="City" name="city" type="input" required="true"/>
						</aui:col>
						<aui:col width="25">
					...
					<aui:row>
						...
						<aui:col width="25">
							<aui:input label="Zipcode" name="zip" type="input" required="true"/>
						</aui:col>
					</aui:row>
				</aui:fieldset>
				<aui:fieldset>
					...
					<aui:row>
						<aui:col width="100">
							<aui:input label="Answer" type="text" name="security_answer" required="true"/>
						</aui:col>
					</aui:row>
				</aui:fieldset>
				<aui:fieldset>
					<aui:row>
						<aui:input required="true" style="margin: 0 0 0 10px" name="accepted_tou" type="checkbox" label="I have read, understand, and agree with the Terms of Use governing my access to and use of the Acme Movie Fanatics  web site." />
					</aui:row>
				</aui:fieldset>
			</aui:fieldset-group>
			<aui:button-row>
