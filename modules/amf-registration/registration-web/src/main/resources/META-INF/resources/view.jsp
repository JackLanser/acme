...
<aui:form name="fm">
	<aui:fieldset-group markupView="lexicon">
		...
		<aui:fieldset style="padding: 10px" label="Phone">
			<aui:row>
				<aui:col width="50">
					<aui:input label="Home Phone" name="homePhone" type="input" />
				</aui:col>
				<aui:col width="50">
					<aui:input label="Mobile Phone" name="mobilePhone" type="input" />
				</aui:col>
			</aui:row>
		</aui:fieldset>
		<aui:fieldset style="padding: 10px" label="Biling Information">
			<aui:row>
				<aui:col width="50">
					<aui:input label="Address 1" name="address1" type="input" />
				</aui:col>
				<aui:col width="25">
		...
		<aui:fieldset>
			<aui:row>
				<aui:col width="100">
					<aui:select name="secuirty_question" label="Security Question">
		...
		<aui:fieldset>
			<aui:row>
				<aui:input style="margin: 0 0 0 10px" name="acceptedTou" type="checkbox" label="I have read, understand, and agree with the Terms of Use governing my access to and use of the Acme Movie Fanatics  web site." />
			</aui:row>
		</aui:fieldset>
	</aui:fieldset-group>
	<aui:button-row>
