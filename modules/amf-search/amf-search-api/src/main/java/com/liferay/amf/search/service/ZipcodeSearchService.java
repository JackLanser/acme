...
/**
 * Provides the remote service interface for ZipcodeSearch. Methods of this
 * service are expected to have security checks based on the propagated JAAS
 * credentials because this service can be accessed remotely.
 *
 * @author Brian Wing Shun Chan
 * @see ZipcodeSearchServiceUtil
 * @generated
 */
@AccessControlled
@JSONWebService
...
public interface ZipcodeSearchService extends BaseService {
