...
public class ZipcodeSearchServiceHttp {
	...
	public static java.util.List<com.liferay.portal.kernel.model.User>
		...
		try {
			MethodKey methodKey = new MethodKey(
				ZipcodeSearchServiceUtil.class, "findUserByZip",
				_findUserByZipParameterTypes0);

			MethodHandler methodHandler = new MethodHandler(
				methodKey, zip, start, end);
	...
	private static Log _log = LogFactoryUtil.getLog(
		ZipcodeSearchServiceHttp.class);

	private static final Class<?>[] _findUserByZipParameterTypes0 =
		new Class[] {String.class, int.class, int.class};
	private static final Class<?>[] _getUserCountParameterTypes1 = new Class[] {
		String.class
	};
